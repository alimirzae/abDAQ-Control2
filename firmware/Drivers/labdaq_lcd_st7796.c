...
static void lcd_hw_init(void){
 ...
 {uint8_t d=0xC3;wr(0xF0,&d,1);}
 {uint8_t d=0x96;wr(0xF0,&d,1);}
 {uint8_t d=0x28;wr(0x36,&d,1);} /* landscape/BGR */
 {uint8_t d=0x55;wr(0x3A,&d,1);} /* RGB565 */
 {uint8_t d=0x01;wr(0xB4,&d,1);}
 {uint8_t d=0xC6;wr(0xB7,&d,1);}
 {uint8_t d=0x06;wr(0xC1,&d,1);}
 {uint8_t d=0xA7;wr(0xC2,&d,1);}
 {uint8_t d=0x18;wr(0xC5,&d,1);}
 {uint8_t d[]={0x40,0x8A,0x00,0x00,0x29,0x19,0xA5,0x33};wr(0xE8,d,8);}
 {uint8_t d[]={0xF0,0x09,0x0B,0x06,0x04,0x15,0x2F,0x54,0x42,0x3C,0x17,0x14,0x18,0x1B};wr(0xE0,d,14);}
 {uint8_t d[]={0xE0,0x09,0x0B,0x06,0x04,0x03,0x2B,0x43,0x42,0x3B,0x16,0x14,0x17,0x1B};wr(0xE1,d,14);}
 {uint8_t d=0x3C;wr(0xF0,&d,1);}
 {uint8_t d=0x69;wr(0xF0,&d,1);}
